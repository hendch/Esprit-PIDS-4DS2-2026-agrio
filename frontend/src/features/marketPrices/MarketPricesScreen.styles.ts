...
export const styles = StyleSheet.create({
  ...
  recTitle: { fontSize: 17, fontWeight: '700', color: '#2C2C2C', marginBottom: 14 },
  recLoadingRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 8 },
  recLoadingText: { fontSize: 13, color: '#888' },
  recBannerWait: {
  ...
  recBannerText: { fontSize: 14, fontWeight: '700' },
  recBoxRow: { flexDirection: 'row', gap: 10, marginBottom: 14 },
  recBox: {
    flex: 1,
    borderRadius: 12,
    borderWidth: 2,
  ...
  recBoxGreen: { borderColor: '#4CAF50', backgroundColor: '#F1FBF2' },
  recBoxRed:   { borderColor: '#E53935', backgroundColor: '#FFF5F5' },
  recBoxLabel: { fontSize: 11, fontWeight: '700', marginBottom: 4 },
  recBoxLabelGreen: { color: '#2E7D32' },
  recBoxLabelRed:   { color: '#C62828' },
  recBoxMonth: { fontSize: 13, fontWeight: '800', color: '#2C2C2C', marginBottom: 4 },
  recBoxPrice: { fontSize: 13, color: '#444', marginBottom: 6 },
  recBadge: { alignSelf: 'flex-start', borderRadius: 8, paddingHorizontal: 8, paddingVertical: 3, marginBottom: 6 },
  recBadgeGreen: { backgroundColor: '#C8E6C9' },
  recBadgeRed:   { backgroundColor: '#FFCDD2' },
  recBadgeText: { fontSize: 11, fontWeight: '700' },
  recBadgeTextGreen: { color: '#1B5E20' },
  recBadgeTextRed:   { color: '#B71C1C' },
  recBoxRange: { fontSize: 10, color: '#888', lineHeight: 14 },
  recAdviceBox: {
    backgroundColor: '#F5F5F5',
    borderRadius: 10,
    padding: 12,
  ...
  recAdviceText: { fontSize: 13, color: '#444', lineHeight: 20 },
  recAvoidBox: {
  ...
  recFootnote: { fontSize: 11, color: '#AAA', marginTop: 4, textAlign: 'center' },
